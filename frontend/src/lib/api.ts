...
export const events = {
  ...
  /**
   * NEW — Admin: Get all ticket buyers for an event
   * GET /api/events/admin/:id/tickets
   */
  getBuyers: (eventId: string) =>
    request<{ buyers: EventTicketBuyer[] }>(`/events/admin/${eventId}/tickets`)
};
...
/**
 * NEW TYPE — Ticket buyers for Admin
 */
